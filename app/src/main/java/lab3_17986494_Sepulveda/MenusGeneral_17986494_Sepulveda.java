        ...
        while (choice != MENU_EXIT_OPTION && !returnToPrevMenu) {
            ...
            try {
                ...
                switch (choice) {
                    //Conversación
                    case 1:
                        System.out.print("Iniciando conversación\n");
                        System.out.print("Para terminar la interacción, en cualquier momento ingrese 'exit'\n");
                        Scanner interactInput = new Scanner(System.in);
                        try{
                            sys.systemInteraction(interactInput);
                        }catch (NullPointerException e){
                            System.out.println("ERROR: Opción enlaza a chatbot inexistente o inválido");
                            System.out.println("Se ha terminado la interacción");
                        }catch (NoSuchElementException e){
                            System.out.println("ERROR: Opción enlaza a flujo inexistente o inválido");
                            System.out.println("Se ha terminado la interacción");
                        }                            
                        break;
                    //Simulacion
